            ...
            <div className="product-grid">
              <article className="product-card product-go" id="product-go" aria-labelledby="go-title">
                <div className="product-visual go-visual">
                  <img src={asset("media/v2/go-food-960.webp")} srcSet={`${asset("media/v2/go-food-480.webp")} 480w, ${asset("media/v2/go-food-960.webp")} 960w`} sizes="(max-width: 800px) 55vw, 340px" alt={text.go.imageAlt} width="960" height="1280" loading="eager" fetchPriority="high" decoding="async" />
              ...
              <article className="product-card product-cet" aria-labelledby="cet-title">
                <a className="product-visual cet-visual" href="https://www.cettong.com" target="_blank" rel="noopener noreferrer" aria-label={text.cet.visit}>
                  <img src={asset("media/v2/cettong-1280.webp")} srcSet={`${asset("media/v2/cettong-640.webp")} 640w, ${asset("media/v2/cettong-1280.webp")} 1280w`} sizes="(max-width: 800px) calc(100vw - 32px), (max-width: 1320px) calc(50vw - 61px), 600px" alt={text.cet.imageAlt} width="1731" height="909" loading="eager" decoding="async" />
                </a>
                <div className="product-body">
              ...
              <article className="product-card product-cet-legacy" aria-labelledby="cet-legacy-title">
                <a className="product-visual cet-legacy-visual" href="https://www.cettong.cn" target="_blank" rel="noopener noreferrer" aria-label={text.legacy.visit}>
                  <img src={asset("products/cettong-v1-logo.webp")} alt={text.legacy.imageAlt} width="120" height="80" loading="eager" decoding="async" />
              ...
              <article className="product-card product-cofate" aria-labelledby="cofate-title">
                <a className="product-visual cofate-visual" href="https://www.cofate.com" target="_blank" rel="noopener noreferrer" aria-label={text.cofate.visit}>
                  <img src={asset("media/v2/cofate-1280.webp")} srcSet={`${asset("media/v2/cofate-640.webp")} 640w, ${asset("media/v2/cofate-1280.webp")} 1280w`} sizes="(max-width: 800px) calc(100vw - 32px), (max-width: 1320px) calc(50vw - 61px), 600px" alt={text.cofate.imageAlt} width="1536" height="1024" loading="eager" decoding="async" />
                </a>
                <div className="product-body">
